...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Goddamn, You're Good.",			"Beat A Dumb Asshole's Week on Hard with no Misses.",	'ada_nomiss',	false],
		["Welcome To The Real World, Kid.",	"Beat Eliot's Week on Hard with no Misses.",	'eliot_nomiss',			false],
		["Seven The Dead Man",			"Beat Seven's Week on Hard with no Misses.",		'seven_nomiss',			false],
		["Brain Damage", 				"Play the FNF mod.", 								'brain', 				false]
